        ...
        docRef.get().then(function(doc) {
            if (doc.exists) {
                ...
                if (userData.joinDate) {
                    ...
                    document.getElementById('join-date').innerText = joinDate.toDateString();
                } else {
                    document.getElementById('join-date').innerText = 'N/A';
                }

                document.getElementById('completed-challenges').innerText = userData.completedChallenges || 0;
                document.getElementById('user-rank').innerText = userData.rank || 'N/A';
